...
void pigen_add_clear(pigen_clears *clears, const char *target, size_t target_length, const char *guard, size_t guard_length, const char *domain, size_t domain_length, int is_flush);
