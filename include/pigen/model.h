...
typedef struct { char *name; char transfer_type; int is_internal; int is_output; char *data_type; char *fifo_depth; } pigen_primitive;
typedef struct { pigen_primitive *items; size_t count; size_t capacity; } pigen_primitives;
typedef struct { char *destination; char *expression; char *guard; char *domain; char destination_code; size_t group; size_t order; } pigen_assignment;
